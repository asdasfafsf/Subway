...
import org.elasticsearch.toy.analysis.HanguelJamoMorphTokenizer;
import org.elasticsearch.toy.model.Subway;
import org.elasticsearch.toy.model.SubwayDocument;
...
public class CsvToFlatFileApplication {
    ...
    public static void translateSubwayDocuments() {
        ...
        System.out.println("Total Converted Documents : {}" + subDocs.size());
    }
    ...
    public static void generateSubwayFlatFile() {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            System.out.println("수행시간: " + (end - start) + " ms");
            System.out.println("Total Generated Documents : {}" + subDocs.size());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
